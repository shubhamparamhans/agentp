...
| File | Purpose |
|------|---------|
| `docs/architecture/backend.md` | Active backend architecture reference |
| `docs/architecture/frontend.md` | Active frontend architecture reference |
| `docs/registry/capabilities-matrix.md` | Current capability inventory |
| `docs/architecture/query-dsl.md` | Active DSL query specification |
| `docs/features/postgres-support/summary.md` | PostgreSQL feature area |
| `docs/engineering/quick-start.md` | This file |
